  ...
  const testimonials = [
    {
      ...
      position: 'Выпускник 3-го потока'
    },
    {
      id: 2,
      ...
      image: '/lovable-uploads/897a2b54-4b4a-4946-a08b-5c76b0474438.png', // Используем имеющееся изображение как заглушку
      rating: 5,
      quote: 'Несмотря на то, что курс больше ориентирован на мужчин, я получила колоссальный опыт и поддержку от команды. Занятия по кроссфиту и пробежки закаливают не только тело, но и характер. Безумно благодарна тренерам за индивидуальный подход!',
      position: 'Участница специального потока'
    },
    {
      id: 3,
      ...
      position: 'Выпускник 2-го потока'
    }
  ];
