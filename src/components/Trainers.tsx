...
const trainers = [
  {
    ...
    experience: '12+ лет практики бразильского джиу-джитсу, черный пояс.',
    bio: 'Дмитрий — мастер бразильского джиу-джитсу с многолетним опытом соревнований. Он обучает не только технике борьбы, но и философии этого искусства. Его подход развивает тактическое мышление и учит находить решения в сложных ситуациях.'
  },
  {
    id: 2,
    name: 'Али Валиев',
