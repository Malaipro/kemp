...
const trainers = [
  ...
  },
  {
    ...
    experience: '15+ лет опыта в тактической подготовке и безопасности, сертифицированный инструктор.',
    bio: 'Тагир Валеев — эксперт по тактической медицине и безопасности. Он обучает самообороне с разрешёнными средствами, практике в реальных сценариях и оказанию первой помощи. Его занятия развивают тактическое мышление, готовность к экстремальным ситуациям и командную работу.'
  }
];
