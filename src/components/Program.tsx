...
const programs = [
  ...
  {
    id: 2,
    title: 'Джиу-джитсу - Шахматы в мире единоборств',
    description: 'Изучение техники борьбы, захватов и подчинений. Шахматы тела и разума - тактическое мышление и самоконтроль.',
  ...
  {
    id: 6,
    title: 'Финальные испытания и краш-тесты по единоборствам',
    description: 'Гонка Героев - итоговое испытание всех навыков. Проверка физической и психологической готовности.',
