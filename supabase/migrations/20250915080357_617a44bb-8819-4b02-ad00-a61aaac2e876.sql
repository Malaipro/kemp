...
CREATE TABLE public.прогресс_аскез (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE public.требования_тотемов (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  totem_type totem_type NOT NULL,
  name TEXT NOT NULL,
  description TEXT,
...
CREATE INDEX idx_участники_user_id ON public.участники(user_id);
CREATE INDEX idx_кэмп_активности_participant_id ON public.кэмп_активности(participant_id);
CREATE INDEX idx_кэмп_активности_date ON public.кэмп_активности(activity_date);
CREATE INDEX idx_cooper_test_participant_id ON public.cooper_test_results(participant_id);
CREATE INDEX idx_contact_rate_limit_ip ON public.contact_rate_limit(ip_address);
